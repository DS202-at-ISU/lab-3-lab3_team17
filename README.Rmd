...
> Is Jocasta truly the MVP? The author states, "The MVP of the Earth-616 Marvel Universe Avengers has to be Jocasta — an android based on Janet van Dyne and built by Ultron".
...
# Create a table to find who died the most.

deaths %>% count(Time)

# The table indicates one person died 5 times, which is the most of any Avenger. Then, use the which function to find who it is.

avengersmvp <- deaths$Name.Alias[which(deaths$Time == 5)]
...
### Include your answer
Michael: Jocasta has died 5 times (wow) which is far more than any other Avenger. I think it's safe to Jocasta is the MVP.
